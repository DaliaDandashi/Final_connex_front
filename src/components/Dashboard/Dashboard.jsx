...
import './Dashboard_Style.js';
import { useHistory } from "react-router";
import { Item, Button, Text, Logo, SidebarContainer, SlickBar, Profile, Details, Name, Logout, Container } from './Dashboard_Style';
import SessionContext from "../../components/session/SessionContext.js";
...
export default function Dashboard() {
    ...
    return (
        <div className="Dash_div">
            {/* <button onClick={() => history.push('/mssg')}>Message</button> */}
                ...
                <SidebarContainer>
                    ...
                    <Item
                        ...
                        >
                            ...
                            <Text clicked={click}>Contact List</Text>
                        </Item>
                        <Item
                            onClick={() => history.push('/List_driver')}
                        >
                            ...
                            <Text clicked={click}>Driver List</Text>
                        </Item>
                        <Item
                            onClick={() => history.push('/List_user')}
                        >
                            ...
                            <Text clicked={click}>User List</Text>
                        </Item>
                        <Item onClick={() => history.push('/get_in_touch')}
                        >
